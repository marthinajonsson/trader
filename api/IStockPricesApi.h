...
/// <summary>
    ...
    virtual StockPricesLastRespV1 Stockpriceslastv1 (string authKey, string version) = 0;
    /// <summary>
    ...
    virtual StockPricesRespV1 Stockpricesv1 (int insid, string authKey, string from, string to) = 0;
};
